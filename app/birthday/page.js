...
//                 className="bg-gradient-to-r from-red-500 to-pink-600 text-white px-10 py-5 rounded-2xl text-xl font-bold hover:scale-105 transform transition-all duration-300 shadow-2xl animate-bounce border-2 border-red-800/50"
//               >
//                 {steps[2].buttonText}
//               </button>
//             </div>
...
// git add .
// git commit -m "Updated title and description for portfolio site"
